...
export function ProductImageUploader({ images, onChange, onError, title = "Mahsulot rasmlari", projectLabels = false, disabled = false }: { images: ProductImagePreview[]; onChange: (images: ProductImagePreview[]) => void; onError: (message: string) => void; title?: string; projectLabels?: boolean; disabled?: boolean }) {
