...
const DB_SCHEMA_REVISION = "20260921100106";
...
export function getDb(): PrismaClient {
  ...
  if (existing) {
    ...
    if (typeof delegates.project?.findMany === "function" && globalForDb.buyukKaravanDbRevision === DB_SCHEMA_REVISION) return existing;
